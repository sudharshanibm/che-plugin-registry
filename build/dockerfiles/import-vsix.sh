...
ARCH=$(uname -m)
if [[ "$ARCH" == "s390x" ]]; then
  NODE_URL="https://nodejs.org/download/release/v18.16.1/node-v18.16.1-linux-s390x.tar.gz"
else
  NODE_URL="https://nodejs.org/download/release/v18.16.1/node-v18.16.1-linux-x64.tar.gz"
fi
